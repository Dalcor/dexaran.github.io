  ...
  return (
    <div className="flex gap-[10px]">
      <img
        ...
        height={38}
        width={38}
        className="w-[38px] h-[38px] border border-[#30363D] rounded-full hidden xl:block group-hover:border-main-red duration-200"
      />
      <div className="flex flex-col group-hover:shadow-card-hover-red duration-200">
        {/* Header */}
        <div className="flex justify-between items-center text-[15px] bg-[#161B22] px-4 xl:px-[18px] py-2 xl:py-[11px] rounded-t-[6px] border border-[#30363D] group-hover:border-main-red group-hover:border-b-[#30363D] duration-200">
        ...
        {/* Body */}
        <div className="px-[18px] py-[15px] bg-[#0D1117] rounded-b-[6px] border border-[#30363D] border-t-0 text-[14px] xl:text-[16px] font-medium group-hover:border-main-red duration-200">
          {content}
        </div>
      </div>
    </div>
...
export const TwitterComment = ({
  ...
  return (
    <div className="flex flex-col bg-[#17202A] px-[16px] py-[14px] border border-[#455362] rounded-[12px] gap-3 group-hover:shadow-card-hover-red duration-200 group-hover:border-main-red">
      {/* Header */}
...
export const RedditPost = ({
  ...
  return (
    <div className="flex flex-col bg-[#0D1416] px-[16px] py-[16px] border border-[#3A444C] rounded-[8px] group-hover:shadow-card-hover-red duration-200 group-hover:border-main-red">
...
export const BeincryptoPost = () => {
  return (
    <div className="flex flex-col bg-white px-4 py-4 xl:px-5 xl:py-5 border border-border-secondary rounded-3 xl:rounded-[20px] group-hover:shadow-card-hover-red duration-200 group-hover:border-main-red">
...
export const Etherscan = () => {
  return (
    <div className="flex flex-col border border-border-secondary rounded-[12px] overflow-hidden group-hover:shadow-card-hover-red duration-200 group-hover:border-main-red">
      <img
